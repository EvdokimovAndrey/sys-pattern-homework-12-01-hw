...
| Однонаправленная репликация: данные идут только от Master к Slave | Двунаправленная репликация: данные синхронизируются между всеми узлами |
| Slave не может принимать запросы на запись | Все узлы могут принимать запросы на запись |
